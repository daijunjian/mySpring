								...
								<TBODY>
									<TR height=25 >
										<TD align="left" background="${pageContext.request.contextPath }/images/b-info.gif"  vAlign="middle">
											...
											&nbsp; <A class="cl" onclick="expand('KB0'); false" href="#">&nbsp;技术设施维护管理</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
								...
								<TBODY>
									...
									<TR height=25>
										<TD background="${pageContext.request.contextPath }/images/b-info.gif" align="left" vAlign="middle">
											...
											&nbsp; <A class="cl" onclick="expand('KB1'); false" href="#">&nbsp;技术资料图纸管理</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
								...
								<TBODY>
									...
									<TR height=25>
										<TD background="${pageContext.request.contextPath }/images/b-info.gif" align="left" vAlign="middle">
											...
											&nbsp; <A class="cl" onclick="expand('KB2'); false" href="#">&nbsp;站点设备运行管理</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
								...
								<TBODY>
									...
									<TR height=25>
										<TD background="${pageContext.request.contextPath }/images/b-info.gif" align="left" vAlign="middle">
											...
											&nbsp; <A class="cl" onclick="expand('KB3'); false" href="#">&nbsp;监测台建筑管理</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
								...
								<TBODY>
									...
									<TR height=25>
										<TD background="${pageContext.request.contextPath }/images/b-info.gif" align="left" vAlign="middle">
											...
											&nbsp; <A class="cl" onclick="expand('KB4'); false" href="#">&nbsp;系统管理</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
								...
								<TBODY>
									...
									<TR height=25>
										<TD background="${pageContext.request.contextPath }/images/b-info.gif" align="left" vAlign="middle">
											...
											&nbsp; <A class="cl" onclick="expand('KB5'); false" href="#">&nbsp;审批流转</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
					    ...
					    <DIV class="child" id="KB5Child">
							<TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
								<TBODY>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_myTaskListHome.do" target="mainFrame">待我审批</A>
										</TD>
									</TR>
									
									<TR>
										<TD class="box06" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_myApplicationListHome.do" target="mainFrame">我的申请查询</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
