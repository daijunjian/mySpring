...
<link href="${pageContext.request.contextPath }/css/Style.css" type="text/css" rel="stylesheet">
  ...
  document.Form1.action="elecCommonMsgAction_save.do";
  ...
  var len = 500 ;
	...
	function openContenFrame(){
	    ...
	    setTimeout('openContenFrame()',5000) ;//每隔0.1秒执行openContenFrame()
	}
	function loading(){
				...
				<td class="ta_01" align="center" bgColor="#f5fafe" colspan=3>			
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
								...
								<td style="HEIGHT:22px" align="center" width="40%">i
									<s:property value="%{DevRun}"/>
								</td>
								<td style="HEIGHT:22px" align="center" width="20%">l
