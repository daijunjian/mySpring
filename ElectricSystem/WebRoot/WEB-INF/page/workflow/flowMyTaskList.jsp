...
<body>
		...
		<form id="Form1" name="Form1" action="workflow/elecApplicationFlowAction_myTaskListHome.do" method="post" style="margin:0px;"> 
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe" colspan="2">			
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<s:if test="#request.taskList!=null && #request.taskList.size()>0" >
								<s:iterator value="%{#request.taskList}" var="task">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td style="HEIGHT:22px" align="center" width="25%">
											${task.applicationUserName} 
										</td>
										<td style="HEIGHT:22px" align="center" width="23%">
											${task.applyTime} 
										</td>
										<td style="HEIGHT:22px" align="center" width="10%">
											<a id="Form2_" href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_flowApprove.do?applicationID=${task.applicationID }&taskID=${task.taskID }"><img src="${pageContext.request.contextPath }/images/handle.gif" width="16" height="16" border="0" style="CURSOR:hand"></a>												
										</td>
										<td style="HEIGHT:22px" align="center" width="12%">
											<a id="Form2_" href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_flowApprovedHistory.do?applicationID=${task.applicationID }"><img src="${pageContext.request.contextPath }/images/button_view.gif" border="0" style="CURSOR:hand"></a>													
										</td>
									</tr>
								</s:iterator>
							</s:if>
