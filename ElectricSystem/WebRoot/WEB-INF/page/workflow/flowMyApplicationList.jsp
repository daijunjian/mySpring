...
<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_myApplicationListHome.do" method="post" style="margin:0px;"> 
			<table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				...
				<tr>
					...
					申请模板：</td>
					<td class="ta_01" >
						<s:select list="#request.temList" name="applicationTemplateID" id="applicationTemplateID"
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe" colspan="2">			
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<s:if test="#request.flowList!=null && #request.flowList.size()>0">
								<s:iterator value="%{#request.flowList}" var="flow">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										<td style="HEIGHT:22px" align="center" width="30%">
											${flow.title }
										</td>
										<td style="HEIGHT:22px" align="center" width="25%">
											${flow.applicationUserName }
										</td>
										...
										<td style="HEIGHT:22px" align="center" width="12%">
											<a id="Form2_" href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_flowApprovedHistory.do?applicationID=${flow.applicationID }"><img src="${pageContext.request.contextPath }/images/button_view.gif" border="0" style="CURSOR:hand"></a>													
										</td>
									</tr>
								</s:iterator>
							</s:if>
